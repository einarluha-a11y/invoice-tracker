...
Например:
```bash
railway variables set MERIT_API_ID=abc123xyz
railway variables set MERIT_API_KEY=supersecretkey
```
...
Или полный sync всех pending:
```bash
node automation/merit_sync.cjs --sync-all
```
