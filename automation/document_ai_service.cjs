...
- The INVOICE ID is ONLY the value in the FIRST column ("PVM sąskaita-faktūra / Invoice"). Example: "26/4211005335".
- The TRACKING NUMBER in the SECOND column ("Užsakymo nr. / Tracking no.") e.g. "42260300810" is NEVER the invoice ID.
- The VENDOR is ALWAYS the logistics company in the top-left header (e.g. "NUNNER Logistics UAB"), NEVER the "Siuntėjas / Shipper" (e.g. "PACKAGING SOLUTIONS NUR-SULTAN") or "Gavėjas / Consignee".
